...
struct config5 : nnet::conv2d_config {
    ...
    static const unsigned out_height = 61;
    ...
    static const ap_uint<filt_height * filt_width> pixels[min_height * min_width];
    static const unsigned n_partitions = 3721;
    static const unsigned n_pixels = out_height * out_width / n_partitions;
    template<class data_T, class CONFIG_T>
...
struct relu_config7 : nnet::activ_config {
    static const unsigned n_in = 74420;
    static const unsigned table_size = 1024;
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned reuse_factor = 1;
    typedef activation_955_table_t table_t;
};

// depthwise_conv2d_203
...
struct config8 : nnet::conv2d_config {
    ...
    static const unsigned pad_left = 0;
    static const unsigned pad_right = 0;
    static const unsigned in_height = 61;
    static const unsigned in_width = 61;
    ...
    static const unsigned stride_height = 1;
    static const unsigned stride_width = 1;
    static const unsigned out_height = 59;
    ...
    static const unsigned strategy = nnet::latency;
    static const nnet::conv_implementation implementation = nnet::conv_implementation::linebuffer;
    static const unsigned min_height = 61;
    static const unsigned min_width = 61;
    static const ap_uint<filt_height * filt_width> pixels[min_height * min_width];
...
struct relu_config10 : nnet::activ_config {
    static const unsigned n_in = 69620;
    static const unsigned table_size = 1024;
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned reuse_factor = 1;
    typedef activation_956_table_t table_t;
};

// depthwise_conv2d_204
struct config11_mult : nnet::dense_config {
    static const unsigned n_in = 5120;
    static const unsigned n_out = 20;
    static const unsigned reuse_factor = 1;
    static const unsigned strategy = nnet::latency;
    static const unsigned n_zeros = 0;
...
struct config11 : nnet::conv2d_config {
    ...
    static const unsigned pad_left = 0;
    static const unsigned pad_right = 0;
    static const unsigned in_height = 59;
    static const unsigned in_width = 59;
    static const unsigned n_chan = 20;
    static const unsigned filt_height = 16;
    static const unsigned filt_width = 16;
    static const unsigned kernel_size = filt_height * filt_width;
    static const unsigned n_filt = 20;
    static const unsigned stride_height = 4;
    static const unsigned stride_width = 4;
    ...
    static const unsigned strategy = nnet::latency;
    static const nnet::conv_implementation implementation = nnet::conv_implementation::linebuffer;
    static const unsigned min_height = 59;
...
struct config15 : nnet::dense_config {
    static const unsigned n_in = 2420;
    static const unsigned n_out = 5;
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 0;
    static const unsigned n_nonzeros = 12100;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;
    typedef model_default_t bias_t;
...
struct softmax_config16 : nnet::activ_config {
    ...
    typedef dense_295_softmax_exp_table_t exp_table_t;
    typedef dense_295_softmax_inv_table_t inv_table_t;
};
