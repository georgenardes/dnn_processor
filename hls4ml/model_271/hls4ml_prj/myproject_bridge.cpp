...
void myproject_float(
    ...
    myproject(input_1_ap,layer14_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_14>(layer14_out_ap, layer14_out);
}

void myproject_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer14_out[N_LAYER_14]
) {
    hls::stream<input_t> input_1_ap("input_1");
    ...
    nnet::convert_data<result_t, double, N_LAYER_14>(layer14_out_ap, layer14_out);
}
}
